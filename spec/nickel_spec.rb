...
describe "A daily occurrence" do 
  ...
  it "should have a start time" do 
    @occurs.start_time.readable.should == "11:00:00"
  end
end
...
describe "A weekly occurrence" do
  ...
  it "should start at 5pm" do 
    @occurs.start_time.readable.should == "17:00:00"
  end
...
describe "Multiple occurrences" do 
  ...
  it "should occur at 2pm on both days" do 
    @n.occurrences[0].start_time.readable.should == "14:00:00"
    @n.occurrences[1].start_time.readable.should == "14:00:00"
  end
end
...
describe "Setting current time" do
  ...
  it "should occur relative to the time zone" do
    n = Nickel.parse "lunch 3 days from now", Time.now.utc
    n.occurrences.first.start_date.date.should == (Time.now.utc + 3*60*60*24).strftime("%Y%m%d")
  end
